# PrismTextureStreamerFB 2.5 — Build, Install, and Use

## A. Update the GitHub repository

1. Extract `PrismTextureStreamerFB-2.5.0-reverse-profiles-source.zip`.
...
6. Download the `PrismTextureStreamerFB-2.5.0-reverse-profiles` artifact.
