...
$Package = Join-Path $ProjectRoot 'x64\Release\PrismTextureStreamerFB-3.9.3-spotify-detached-audio'
...
@"
PrismTextureStreamerFB 3.9.3 Spotify Detached-Audio Filter + Session Backups
