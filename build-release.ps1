...
$Package = Join-Path $ProjectRoot 'x64\Release\PrismTextureStreamerFB-3.9.0-session-backup-menu'
...
@"
PrismTextureStreamerFB 3.9 Spotify Session + Backups + Gamepad Menu
