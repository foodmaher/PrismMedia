...
$Package = Join-Path $ProjectRoot 'x64\Release\PrismTextureStreamerFB-3.5.0-environment-audio'
...
Copy-Item (Join-Path $ProjectRoot 'V3.5-ENVIRONMENT-AUDIO.md') $Docs
...
@"
PrismTextureStreamerFB 3.5 Environment Audio
