...
$Package = Join-Path $ProjectRoot 'x64\Release\PrismTextureStreamerFB-3.11.21-independent-capture-export'
...
@"
PrismTextureStreamerFB 3.11.21 Independent Capture Export
