...
$Package = Join-Path $ProjectRoot 'x64\Release\PrismTextureStreamerFB-3.8.0-spotify-gamepad-diagnostics'
...
@"
PrismTextureStreamerFB 3.8 Spotify + Gamepad + Diagnostics
