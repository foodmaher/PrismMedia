...
$Package = Join-Path $ProjectRoot 'x64\Release\PrismTextureStreamerFB-3.11.19-independent-snapshot-lifetime'
...
@"
PrismTextureStreamerFB 3.11.19 Independent Snapshot Lifetime
