...
$Package = Join-Path $ProjectRoot 'x64\Release\PrismTextureStreamerFB-3.11.20-independent-snapshot-retention'
...
@"
PrismTextureStreamerFB 3.11.20 Independent Snapshot Retention
